# App Icon Assets - SwiftUI

This directory contains the app icon assets for the **Sticky ToDo SwiftUI** application.
...
**AppKit icons:** `/home/user/sticky-todo/StickyToDo-AppKit/Assets.xcassets/AppIcon.appiconset/`
